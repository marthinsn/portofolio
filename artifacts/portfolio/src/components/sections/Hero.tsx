...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center px-6 md:px-16 overflow-hidden">
      <motion.div
        className="absolute inset-0 pointer-events-none"
        animate={{ x: mousePos.x * 0.5, y: mousePos.y * 0.5 }}
        transition={{ type: "spring", stiffness: 50, damping: 20 }}
        style={{
          background: "radial-gradient(ellipse 60% 50% at 70% 50%, rgba(138,79,85,0.15) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-5xl w-full">
        <motion.div
          ...
          className="space-y-6"
        >
          <motion.p variants={stagger.item} className="text-[#E4A390] text-sm tracking-[0.3em] uppercase font-sans font-medium">
            Welcome
          </motion.p>
          ...
          <motion.div variants={stagger.item} className="relative">
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-serif font-bold text-white leading-[0.9] tracking-tight heading-glow">
              Alex
              <br />
              <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, #E4A390 0%, #D49C68 50%, #8A4F55 100%)" }}>
                Johnson
              </span>
            </h1>
          </motion.div>

          <motion.p variants={stagger.item} className="text-[#E4A390]/80 text-base md:text-lg tracking-widest uppercase font-sans font-light max-w-xl">
            Information Technology Student &nbsp;·&nbsp; Full Stack Developer &nbsp;·&nbsp; Problem Solver
          </motion.p>

          <motion.p variants={stagger.item} className="text-white/60 text-lg md:text-xl font-sans font-light max-w-lg leading-relaxed">
          ...
          <motion.div variants={stagger.item} className="flex flex-wrap gap-4 pt-4">
            <MagneticButton
              ...
              style={{ background: "linear-gradient(135deg, #D49C68, #E4A390)" } as React.CSSProperties}
